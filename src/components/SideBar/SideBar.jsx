...
const isUnreadForMe = (msg = {}) => {
  ...
  // fallback: if messageState indicates it was received (i.e., sent by other) and no read flag
  if (msg.messageState && msg.messageState.toLowerCase() === "recieved") {
    return true; // assume unread until flagged
  }

  // default: assume read (not counted)
  return false;
};
...
/* ---------------------- Chats (new format: messages as arrays) ---------------------- */
...
const chats = [
  {
    ...
    messages: [
      { id: "m1", text: "message1", createdAt: "2025-10-16T14:30:00", messageState: "sent", readedByUser: "yes" },
      { id: "m2", text: "message2", createdAt: "2025-10-17T14:35:00", messageState: "recieved", readedByMe: "yes" },
      { id: "m3", text: "message3", createdAt: "2025-10-17T17:55:15", messageState: "sent", readedByUser: "yes" },
      { id: "m4", text: "message4", createdAt: "2025-11-16T22:30:00", messageState: "recieved", readedByMe: "no" }
    ],
  },
  {
    _id: 2,
    ...
    messages: [
      { id: "m1", text: "message1", createdAt: "2025-11-17T14:30:00" },
      { id: "m2", text: "message2", createdAt: "2025-10-17T14:40:00" },
      { id: "m3", text: "message3", createdAt: "2025-11-12T15:33:45" },
      { id: "m4", text: "message4", createdAt: "2025-11-18T11:41:00" }
    ]
  },
  {
    _id: 3,
    ...
    messages: [
      { id: "m1", text: "message1", createdAt: "2025-11-01T14:30:00" },
      { id: "m2", text: "message2", createdAt: "2025-11-05T18:15:50" },
      { id: "m3", text: "message3", createdAt: "2025-11-12T15:01:02" },
      { id: "m4", text: "message4", createdAt: "2025-11-17T13:50:00" }
    ]
  },
  {
    _id: 4,
    ...
    messages: [
      { id: "m1", text: "message1", createdAt: "2025-11-10T14:22:22" },
      { id: "m2", text: "message2", createdAt: "2025-11-11T14:25:00" },
      { id: "m3", text: "message3", createdAt: "2025-11-17T14:30:00" },
      { id: "m4", text: "message4", createdAt: "2025-11-17T14:30:00" }
    ]
  },
  {
    _id: 5,
    ...
    messages: [
      { id: "m1", text: "message1", createdAt: "2025-09-28T22:33:00" },
      { id: "m2", text: "message2", createdAt: "2025-10-01T14:44:00" },
      { id: "m3", text: "message3", createdAt: "2025-10-03T08:10:00" },
      { id: "m4", text: "message4", createdAt: "2025-10-17T15:30:00" }
    ]
  },
  {
    _id: 6,
    ...
    messages: [
      { id: "m1", text: "message1", createdAt: "2025-11-10T14:25:00" },
      { id: "m2", text: "message2", createdAt: "2025-11-17T14:30:00" },
      { id: "m3", text: "message3", createdAt: "2025-11-17T14:30:00" },
      { id: "m4", text: "message4", createdAt: "2025-11-17T14:30:00" }
    ]
  },
  ...
  },
  {
    ...
    messages: [
      { id: "m1", text: "message1", createdAt: "2025-11-17T23:32:00" },
      { id: "m2", text: "message2", createdAt: "2025-11-17T14:30:00" },
      { id: "m3", text: "message3", createdAt: "2025-11-17T14:30:00" },
      { id: "m4", text: "message4", createdAt: "2025-11-17T14:30:00" }
    ]
